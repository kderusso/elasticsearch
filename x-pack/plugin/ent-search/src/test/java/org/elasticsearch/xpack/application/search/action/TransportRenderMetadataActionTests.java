...
public class TransportRenderMetadataActionTests extends ESTestCase {
    public void testWithUnsupportedLicense() {
        ...
        TransportRenderMetadataAction transportAction = new TransportRenderMetadataAction(
        ...
        final AtomicReference<RenderMetadataAction.Response> responseRef = new AtomicReference<>();

        transportAction.doExecute(mock(Task.class), request, new ActionListener<>() {
            @Override
            public void onResponse(RenderMetadataAction.Response response) {
