...
public class RestRenderMetadataAction extends BaseRestHandler {

    public static final String ENDPOINT_PATH = "/" + EnterpriseSearch.SEARCH_APPLICATION_API_ENDPOINT + "/{name}" + "/_render_metadata";

    @Override
    public String getName() {
        return "search_application_render_metadata_action";
    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest restRequest, NodeClient client) throws IOException {
        ...
        return channel -> client.execute(RenderMetadataAction.INSTANCE, finalRequest, new RestToXContentListener<>(channel));
    }
}
